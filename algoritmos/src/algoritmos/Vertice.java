...
public class Vertice implements Comparable<Vertice> {
	...
	public void addIncidentes(Aresta incide) {
		...
		if ( !this.isVizinho(incide.getDestino()) &&
                        incide.getOrigem().getNome().equals(this.getNome()) ){
                    this.addVizinhos(incide.getDestino());
                }else {
                    
                    if ( (incide.getDestino().getNome().equals(this.getNome())) &&
                            (!this.isVizinho((Vertice) incide.getOrigem())) ){
                        
                        this.addVizinhos((Vertice) incide.getOrigem());
                    }
